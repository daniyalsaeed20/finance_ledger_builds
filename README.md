...
- **Compatibility:** `v0.0.3+4` is compatible with `v0.0.2+3`
...
### Compatible previous: `v0.0.2+3`

- **Status:** Compatible with latest (`v0.0.3+4`)
- **Release page:** `https://github.com/daniyalsaeed20/finance_ledger_builds/releases/tag/v0.0.2%2B3`
- **Release notes:** `releases/0.0.2+3/release-notes.md`

[![Download v0.0.2+3 APK](https://img.shields.io/badge/Download-v0.0.2%2B3-informational?style=for-the-badge&logo=android)](https://github.com/daniyalsaeed20/finance_ledger_builds/releases/download/v0.0.2%2B3/chillcheck_v0.0.2+3.apk)
...
- Compatible previous (`0.0.2+3`): `releases/0.0.2+3/release-notes.md`
